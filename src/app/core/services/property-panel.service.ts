...
export class PropertyPanelService {
  ...
  private async registerDefaultPropertyEditors(): Promise<void> {
    try {
      ...
      // Import all property editor components
      const [
        textModule,
        numberModule,
        colorModule,
        ...
        import('../../features/form-builder/components/property-panel/text-property-editor.component'),
        import('../../features/form-builder/components/property-panel/number-property-editor.component'),
        import('../../features/form-builder/components/property-panel/color-property-editor.component'),
        import('../../features/form-builder/components/property-panel/select-property-editor.component'),
        import('../../features/form-builder/components/property-panel/multi-select-property-editor.component'),
        import('../../features/form-builder/components/property-panel/object-property-editor.component'),
        import('../../features/form-builder/components/property-panel/boolean-property-editor.component'),
        import('../../features/form-builder/components/property-panel/array-property-editor.component')
      ]);
      ...
      const editorUpdates = [
        {
          type: 'text' as PropertyType,
          component: textModule.TextPropertyEditorComponent,
          selector: 'app-text-property-editor',
          inputs: {},
          outputs: {}
        },
        {
          type: 'number' as PropertyType,
          component: numberModule.NumberPropertyEditorComponent,
          selector: 'app-number-property-editor',
          inputs: {},
          outputs: {}
        },
        ...
        {
          type: 'color' as PropertyType,
          component: colorModule.ColorPropertyEditorComponent,
          selector: 'app-color-property-editor',
          inputs: {},
          outputs: {}
        },
        {
          type: 'select' as PropertyType,
          component: selectModule.SelectPropertyEditorComponent,
          selector: 'app-select-property-editor',
          inputs: {},
          outputs: {}
        },
        {
          ...
          component: multiSelectModule.MultiSelectPropertyEditorComponent,
        ...
        },
        {
          ...
          component: objectModule.ObjectPropertyEditorComponent,
        ...
        {
          type: 'boolean' as PropertyType,
          component: booleanModule.BooleanPropertyEditorComponent,
          selector: 'app-boolean-property-editor',
          inputs: {},
          outputs: {}
        },
        {
          type: 'array' as PropertyType,
          component: arrayModule.ArrayPropertyEditorComponent,
          selector: 'app-array-property-editor',
          inputs: {},
          outputs: {}
        },
  ...
  private async registerElementTypes(): Promise<void> {
    try {
      const module = await import('../configs/element-property-definitions');
      ...
      this.registerElementType({
        ...
        propertySections: module.INPUT_ELEMENT_PROPERTY_SECTIONS || []
      });
      ...
      this.registerElementType({
        ...
        propertySections: module.TEXTAREA_ELEMENT_PROPERTY_SECTIONS || []
      });
      ...
      this.registerElementType({
        ...
        propertySections: module.SELECT_ELEMENT_PROPERTY_SECTIONS || []
      });
      ...
      this.registerElementType({
        ...
        propertySections: module.BUTTON_ELEMENT_PROPERTY_SECTIONS || []
      });
